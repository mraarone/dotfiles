# Filesystem
alias ghbms='cd ${HOME}/git/github/mraarone/'
...
# Note taking
alias work='cd $HOME/git/github/mraarone/work'
alias eod-work='cd $HOME/git/github/mraarone/work && git add . && git commit -anm "`date`" && git push origin main'
