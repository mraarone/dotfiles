...
POWERLEVEL10K_MODE="FuraMono Nerd Font"
...
plugins=(git poetry pip docker docker-compose helm kubectl minikube terraform \
	 vault microk8s istioctl github gh colorize \
	 zsh-autosuggestions zsh-syntax-highlighting history history-substring-search \
